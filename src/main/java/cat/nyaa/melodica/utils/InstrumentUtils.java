...
public class InstrumentUtils {
    ...
    public static org.bukkit.Sound getInstrument(byte instrument) {
        return Sound.valueOf(getInstrumentName(instrument));
    }
    ...
    public static String getInstrumentName(byte instrument) {
        switch (instrument) {
            case 0:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_HARP").name();
            case 1:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_BASS").name();
            case 2:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_BASEDRUM").name();
            case 3:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_SNARE").name();
            case 4:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_HAT").name();
            case 5:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_GUITAR").name();
            case 6:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_FLUTE").name();
            case 7:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_BELL").name();
            case 8:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_CHIME").name();
            case 9:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_XYLOPHONE").name();
            case 10:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_IRON_XYLOPHONE").name();
            case 11:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_COW_BELL").name();
            case 12:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_DIDGERIDOO").name();
            case 13:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_BIT").name();
            case 14:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_BANJO").name();
            case 15:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_PLING").name();
            default:
                return Sound.valueOf("BLOCK_NOTE_BLOCK_HARP").name();
        }
    }
